        ...
        int auto3 = 0;
         while(true){
             try{
                  ...
                  if(auto1 < auto.getMeta().getLocation().x - 125 && auto2 < auto.getMeta().getLocation().x - 125 && auto3 < auto.getMeta().getLocation().x - 125){
             ...
             if(etiqueta.getLocation().x >= auto.getMeta().getLocation().x - 125){
                  if(auto1 > auto2 && auto1 > auto3){
                      JOptionPane.showMessageDialog(null,"Ganó el primer carro");
                  }
